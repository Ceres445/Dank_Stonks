...
class Help(commands.HelpCommand):
    ...
    def embedify(self, title: str, description: str) -> discord.Embed:
        ...
        embed.set_author(name="Dank Trader | Help", icon_url=self.context.bot.user.avatar_url)
        embed.set_footer(icon_url=self.context.author.avatar_url, text=f'Invoked by {self.context.author.name}')
        return embed
